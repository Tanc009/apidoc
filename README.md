...
<head>
  ...
  <title>rate_limit_jiashuo1572420376</title>
...
<body>
  <script>
    ...
    var defs = {}
            defs.returnInt64_returnInt64_request = {
  "properties" : {
    "Author_test" : {
      "type" : "string",
      "description" : "Authorization",
      "title" : "Author_test",
      "x-jdcloud-header" : true
    }
  },
  "requestModel" : false,
  "responseModel" : false,
  ...
  "response" : false,
  "result" : false,
  "operationId" : "returnInt64",
  "operationIdPackage" : "returnint64"
};
            defs.returnInt64_returnInt64_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "string",
  ...
  "operationIdPackage" : "returnint64"
            ...
            defs.createTaskJson_createTaskJson_request = {
  "properties" : {
    "Author_test" : {
      "type" : "string",
      "description" : "Authorization",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "createTaskJson",
  "operationIdPackage" : "createtaskjson"
};
            defs.createTaskJson_createTaskJson_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "$ref" : "#/definitions/createTaskJson_result"
    }
  },
  "requestModel" : false,
  "responseModel" : false,
  ...
  "operationIdPackage" : "createtaskjson"
            ...
            defs.createTaskXml_createTaskXml_request = {
  "properties" : {
    "Author_test" : {
      "type" : "string",
      "description" : "Authorization",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "createTaskXml",
  "operationIdPackage" : "createtaskxml"
};
            defs.createTaskXml_createTaskXml_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "$ref" : "#/definitions/createTaskXml_result"
    }
  },
  "requestModel" : false,
  "responseModel" : false,
  ...
  "operationIdPackage" : "createtaskxml"
            ...
            defs.deleteTask_deleteTask_request = {
  "properties" : {
    "taskid" : {
      "type" : "integer",
      "format" : "int32",
  ...
  "operationIdPackage" : "deletetask"
};
            defs.deleteTask_deleteTask_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "object",
  ...
  "operationIdPackage" : "deletetask"
            ...
            defs.getAllTask_getAllTask_request = {
  "properties" : {
    "title" : {
      "type" : "string",
      "description" : "title",
      "title" : "title",
      "x-jdcloud-query" : true
    },
    "done" : {
      "type" : "string",
      "description" : "done",
  ...
  "operationIdPackage" : "getalltask"
};
            defs.getAllTask_getAllTask_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "object",
  ...
  "operationIdPackage" : "getalltask"
            ...
            defs.getSelectTask_getSelectTask_request = {
  "properties" : {
    "taskid" : {
      "type" : "integer",
      "format" : "int32",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "getSelectTask",
  "operationIdPackage" : "getselecttask"
};
            defs.getSelectTask_getSelectTask_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "$ref" : "#/definitions/getSelectTask_result"
    }
  },
  "requestModel" : false,
  "responseModel" : false,
  ...
  "operationIdPackage" : "getselecttask"
            ...
            defs.patchTaskJson_patchTaskJson_request = {
  "properties" : {
    "taskid" : {
      "type" : "integer",
      "format" : "int32",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "patchTaskJson",
  "operationIdPackage" : "patchtaskjson"
};
            defs.patchTaskJson_patchTaskJson_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "$ref" : "#/definitions/patchTaskJson_result"
    }
  },
  "requestModel" : false,
  "responseModel" : false,
  ...
  "operationIdPackage" : "patchtaskjson"
            ...
            defs.patchTaskXml_patchTaskXml_request = {
  "properties" : {
    "taskid" : {
      "type" : "integer",
      "format" : "int32",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "patchTaskXml",
  "operationIdPackage" : "patchtaskxml"
};
            defs.patchTaskXml_patchTaskXml_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "$ref" : "#/definitions/patchTaskXml_result"
    }
  },
  "requestModel" : false,
  "responseModel" : false,
  ...
  "operationIdPackage" : "patchtaskxml"
            ...
            defs.putTaskJson_putTaskJson_request = {
  "properties" : {
    "taskid" : {
      "type" : "integer",
      "format" : "int32",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "putTaskJson",
  "operationIdPackage" : "puttaskjson"
};
            defs.putTaskJson_putTaskJson_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "$ref" : "#/definitions/putTaskJson_result"
    }
  },
  "requestModel" : false,
  "responseModel" : false,
  ...
  "operationIdPackage" : "puttaskjson"
            ...
            defs.putTaskXml_putTaskXml_request = {
  "properties" : {
    "taskid" : {
      "type" : "integer",
      "format" : "int32",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "putTaskXml",
  "operationIdPackage" : "puttaskxml"
};
            defs.putTaskXml_putTaskXml_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "$ref" : "#/definitions/putTaskXml_result"
    }
  },
  "requestModel" : false,
  "responseModel" : false,
  ...
  "operationIdPackage" : "puttaskxml"
            ...
            defs.getError_getError_request = {
  "properties" : {
    "errno" : {
      "type" : "integer",
      "format" : "int32",
  ...
  "operationIdPackage" : "geterror"
};
            defs.getError_getError_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "object",
  ...
  "operationIdPackage" : "geterror"
            ...
            defs.returnHeader_returnHeader_request = {
  "properties" : {
    "TanCoong" : {
      "type" : "string",
      "description" : "TanCoong",
      "title" : "TanCoong",
      "x-jdcloud-header" : true
    },
    "Lishijun" : {
      "type" : "string",
      "description" : "Lishijun",
      "title" : "Lishijun",
      "x-jdcloud-header" : true
    },
    "Lixuenan" : {
      "type" : "string",
      "description" : "Lixuenan",
      "title" : "Lixuenan",
      "x-jdcloud-header" : true
    }
  },
  ...
  "response" : false,
  "result" : false,
  "operationId" : "returnHeader",
  "operationIdPackage" : "returnheader"
};
            defs.returnHeader_returnHeader_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "object",
  ...
  "operationIdPackage" : "returnheader"
            ...
            defs.returnString_returnString_request = {
  "properties" : {
    "Author_test" : {
      "type" : "string",
      "description" : "Authorization",
  ...
  "operationIdPackage" : "returnstring"
};
            defs.returnString_returnString_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "string",
  ...
  "operationIdPackage" : "returnstring"
            ...
            defs.returnFloat_returnFloat_request = {
  "properties" : {
    "Author_test" : {
      "type" : "string",
      "description" : "Authorization",
  ...
  "operationIdPackage" : "returnfloat"
};
            defs.returnFloat_returnFloat_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "string",
  ...
  "operationIdPackage" : "returnfloat"
            ...
            defs.returnInt32_returnInt32_request = {
  "properties" : {
    "Author_test" : {
      "type" : "string",
      "description" : "Authorization",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "returnInt32",
  "operationIdPackage" : "returnint32"
};
            defs.returnInt32_returnInt32_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "string",
  ...
  "operationIdPackage" : "returnint32"
            ...
            defs.returnBoolean_returnBoolean_request = {
  "properties" : {
    "Author_test" : {
      "type" : "string",
      "description" : "Authorization",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "returnBoolean",
  "operationIdPackage" : "returnboolean"
};
            defs.returnBoolean_returnBoolean_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "string",
  ...
  "operationIdPackage" : "returnboolean"
            ...
            defs.returnDouble_returnDouble_request = {
  "properties" : {
    "Author_test" : {
      "type" : "string",
      "description" : "Authorization",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "returnDouble",
  "operationIdPackage" : "returndouble"
};
            defs.returnDouble_returnDouble_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "string",
  ...
  "operationIdPackage" : "returndouble"
            ...
            defs.returnDate_returnDate_request = {
  "properties" : {
    "Author_test" : {
      "type" : "string",
      "description" : "Authorization",
  ...
  "response" : false,
  "result" : false,
  "operationId" : "returnDate",
  "operationIdPackage" : "returndate"
};
            defs.returnDate_returnDate_response = {
  "type" : "object",
  "properties" : {
    "result" : {
      "type" : "string",
  ...
  <div class="container-fluid">
    <div class="row-fluid">
          ...
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
              ...
              <li class="nav-header" data-group=""><a href="#api">API Methods</a></li>
                    <li data-group="Default" data-name="returnInt64" class="">
                      <a href="#api-Default-returnInt64">returnInt64</a>
                    </li>
                    <li data-group="Default" data-name="createTaskJson" class="">
                      <a href="#api-Default-createTaskJson">createTaskJson</a>
                    </li>
                    <li data-group="Default" data-name="createTaskXml" class="">
                      <a href="#api-Default-createTaskXml">createTaskXml</a>
                    </li>
                    <li data-group="Default" data-name="deleteTask" class="">
                      <a href="#api-Default-deleteTask">deleteTask</a>
                    </li>
                    <li data-group="Default" data-name="getAllTask" class="">
                      <a href="#api-Default-getAllTask">getAllTask</a>
                    </li>
                    <li data-group="Default" data-name="getSelectTask" class="">
                      <a href="#api-Default-getSelectTask">getSelectTask</a>
                    </li>
                    <li data-group="Default" data-name="patchTaskJson" class="">
                      <a href="#api-Default-patchTaskJson">patchTaskJson</a>
                    </li>
                    <li data-group="Default" data-name="patchTaskXml" class="">
                      <a href="#api-Default-patchTaskXml">patchTaskXml</a>
                    </li>
                    <li data-group="Default" data-name="putTaskJson" class="">
                      <a href="#api-Default-putTaskJson">putTaskJson</a>
                    </li>
                    <li data-group="Default" data-name="putTaskXml" class="">
                      <a href="#api-Default-putTaskXml">putTaskXml</a>
                    </li>
                    <li data-group="Default" data-name="getError" class="">
                      <a href="#api-Default-getError">getError</a>
                    </li>
                    <li data-group="Default" data-name="returnHeader" class="">
                      <a href="#api-Default-returnHeader">returnHeader</a>
                    </li>
                    <li data-group="Default" data-name="returnString" class="">
                      <a href="#api-Default-returnString">returnString</a>
                    </li>
                    <li data-group="Default" data-name="returnFloat" class="">
                      <a href="#api-Default-returnFloat">returnFloat</a>
                    </li>
                    <li data-group="Default" data-name="returnInt32" class="">
                      <a href="#api-Default-returnInt32">returnInt32</a>
                    </li>
                    <li data-group="Default" data-name="returnBoolean" class="">
                      <a href="#api-Default-returnBoolean">returnBoolean</a>
                    </li>
                    <li data-group="Default" data-name="returnDouble" class="">
                      <a href="#api-Default-returnDouble">returnDouble</a>
                    </li>
                    <li data-group="Default" data-name="returnDate" class="">
                      <a href="#api-Default-returnDate">returnDate</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        <div id="project">
          <div class="pull-left">
            <h1>rate_limit_jiashuo1572420376</h1>
          </div>
        ...
        <div id="header">
          <div id="api-_">
            ...
            <div class="app-desc">Host</div>
            </br>
            <table id="methodsubtable">
              <tr>
                <th width="150px">Test</th>
                <th>w9najhegwrr2-test.cn-north-1.jdcloud-api.net</th>
              </tr>
              <tr>
                <th width="150px">Preview</th>
                <th>w9najhegwrr2-preview.cn-north-1.jdcloud-api.net</th>
              </tr>
              <tr>
                <th width="150px">Online</th>
                <th>w9najhegwrr2.cn-north-1.jdcloud-api.net</th>
              </tr>
            </table>
            <hr>
            <div></div>
        ...
        <div id="sections">
          <section id="api">
            <h1>API</h1>
                    <div id="api-Default-returnInt64">
                      <article id="api-Default-returnInt64-0" data-group="User" data-name="returnInt64" data-version="0">
                        <div class="pull-left">
                          <h1>returnInt64</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">return_int64</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/returntype/int64</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-returnInt64-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-returnInt64-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-returnInt64-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-returnInt64-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-returnInt64-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-returnInt64-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-returnInt64-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-returnInt64-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-returnInt64-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-returnInt64-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-returnInt64-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-returnInt64-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/returntype/int64"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-returnInt64-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
        try {
            ReturnInt64response result = apiInstance.returnInt64(authorTest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#returnInt64");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-returnInt64-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-returnInt64-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-returnInt64-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance returnInt64With:authorTest
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Default-returnInt64-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');

var api = new .DefaultApi()

var authorTest = authorTest_example; // {String} Authorization
...
api.returnInt64(authorTest, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnInt64-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-returnInt64-0-csharp">
...
namespace Example
{
    public class returnInt64Example
    {
        public void main()
        {
            
            var apiInstance = new DefaultApi();
            var authorTest = authorTest_example;  // String | Authorization (default to Authorization)
            ...
            {
                Debug.Print("Exception when calling DefaultApi.returnInt64: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-returnInt64-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\DefaultApi();
$authorTest = authorTest_example; // String | Authorization

try {
    $result = $api_instance->returnInt64($authorTest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->returnInt64: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnInt64-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;

my $api_instance = ::DefaultApi->new();
my $authorTest = authorTest_example; # String | Authorization

eval { 
    my $result = $api_instance->returnInt64(authorTest => $authorTest);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->returnInt64: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnInt64-0-python">
...
authorTest = authorTest_example # String | Authorization (default to Authorization)

try: 
    api_response = api_instance.return_int64(authorTest)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->returnInt64: %s\n" % e)</code></pre>
                            </div>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <th>Description</th>
                                  ...
                                  <tr><td style="width:150px;">Author_test*</td>
<td>


    <div id="d2e199_returnInt64_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                ...
                <div class="inner required">
                    ...
                    <div id="api-Default-createTaskJson">
                      <article id="api-Default-createTaskJson-0" data-group="User" data-name="createTaskJson" data-version="0">
                        <div class="pull-left">
                          <h1>createTaskJson</h1>
                          <p></p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">create_task_json</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/todo/api/v1/tasks/createTask/json</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-createTaskJson-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-createTaskJson-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-createTaskJson-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-createTaskJson-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-createTaskJson-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-createTaskJson-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-createTaskJson-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-createTaskJson-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-createTaskJson-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-createTaskJson-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-createTaskJson-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-createTaskJson-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/createTask/json"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-createTaskJson-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
         createTaskJsonBody = ; //  | 
        Object jdcloudRequestBody = ; // Object | 
        try {
            result result = apiInstance.createTaskJson(authorTest, createTaskJsonBody, jdcloudRequestBody);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#createTaskJson");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-createTaskJson-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-createTaskJson-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-createTaskJson-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)
 *createTaskJsonBody = ; //  (optional)
Object *jdcloudRequestBody = ; //  (optional)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance createTaskJsonWith:authorTest
    createTaskJsonBody:createTaskJsonBody
    jdcloudRequestBody:jdcloudRequestBody
              completionHandler: ^(result output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Default-createTaskJson-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.createTaskJson(authorTest, opts, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-createTaskJson-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-createTaskJson-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class createTaskJsonExample
    {
        public void main()
        {
            ...
            var apiInstance = new DefaultApi();
            var authorTest = authorTest_example;  // String | Authorization (default to Authorization)
            var createTaskJsonBody = new (); //  |  (optional) 
            var jdcloudRequestBody = new Object(); // Object |  (optional) 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.createTaskJson: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-createTaskJson-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->createTaskJson($authorTest, $createTaskJsonBody, $jdcloudRequestBody);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->createTaskJson: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-createTaskJson-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
my $api_instance = ::DefaultApi->new();
my $authorTest = authorTest_example; # String | Authorization
my $createTaskJsonBody = ::Object::->new(); #  | 
my $jdcloudRequestBody = ::Object::Object->new(); # Object | 

eval { 
    my $result = $api_instance->createTaskJson(authorTest => $authorTest, createTaskJsonBody => $createTaskJsonBody, jdcloudRequestBody => $jdcloudRequestBody);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->createTaskJson: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-createTaskJson-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
authorTest = authorTest_example # String | Authorization (default to Authorization)
createTaskJsonBody =  #  |  (optional)
jdcloudRequestBody =  # Object |  (optional)

try: 
    api_response = api_instance.create_task_json(authorTest, createTaskJsonBody=createTaskJsonBody, jdcloudRequestBody=jdcloudRequestBody)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->createTaskJson: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_createTaskJson_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    Required
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">createTaskJsonBody </td>
<td>
...
$(document).ready(function() {
  var schemaWrapper = {
  "in" : "body",
  "name" : "create_task_jsonBody",
  "description" : "",
  "required" : false
};
  var schema = schemaWrapper.schema;
  if (schema.$ref != null) {
    schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/createTaskJson_')
  ...
  var result = $('#d2e199_createTaskJson_createTaskJsonBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_createTaskJson_createTaskJsonBody"></div>
</td>
</tr>

                                <tr><td style="width:150px;">jdcloudRequestBody </td>
<td>
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_createTaskJson_jdcloudRequestBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_createTaskJson_jdcloudRequestBody"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-createTaskJson-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-createTaskJson-200-schema">
                                  <div id='responses-createTaskJson-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/result"
                                        ...
                                        $('#responses-createTaskJson-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-createTaskJson-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-createTaskJson-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-createTaskXml">
                      <article id="api-Default-createTaskXml-0" data-group="User" data-name="createTaskXml" data-version="0">
                        <div class="pull-left">
                          <h1>createTaskXml</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">create_task_xml</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/todo/api/v1/tasks/createTask/xml</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-createTaskXml-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-createTaskXml-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-createTaskXml-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-createTaskXml-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-createTaskXml-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-createTaskXml-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-createTaskXml-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-createTaskXml-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-createTaskXml-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-createTaskXml-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-createTaskXml-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-createTaskXml-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/createTask/xml"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-createTaskXml-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        Object jdcloudRequestBody = ; // Object | 
        try {
            result result = apiInstance.createTaskXml(authorTest, createTaskXmlBody, jdcloudRequestBody);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#createTaskXml");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-createTaskXml-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-createTaskXml-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-createTaskXml-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)
 *createTaskXmlBody = ; //  (optional)
Object *jdcloudRequestBody = ; //  (optional)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance createTaskXmlWith:authorTest
    createTaskXmlBody:createTaskXmlBody
    jdcloudRequestBody:jdcloudRequestBody
              completionHandler: ^(result output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Default-createTaskXml-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.createTaskXml(authorTest, opts, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-createTaskXml-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-createTaskXml-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class createTaskXmlExample
    {
        public void main()
        {
            ...
            var apiInstance = new DefaultApi();
            var authorTest = authorTest_example;  // String | Authorization (default to Authorization)
            var createTaskXmlBody = new (); //  |  (optional) 
            var jdcloudRequestBody = new Object(); // Object |  (optional) 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.createTaskXml: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-createTaskXml-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->createTaskXml($authorTest, $createTaskXmlBody, $jdcloudRequestBody);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->createTaskXml: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-createTaskXml-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
my $api_instance = ::DefaultApi->new();
my $authorTest = authorTest_example; # String | Authorization
my $createTaskXmlBody = ::Object::->new(); #  | 
my $jdcloudRequestBody = ::Object::Object->new(); # Object | 

eval { 
    my $result = $api_instance->createTaskXml(authorTest => $authorTest, createTaskXmlBody => $createTaskXmlBody, jdcloudRequestBody => $jdcloudRequestBody);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->createTaskXml: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-createTaskXml-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.create_task_xml(authorTest, createTaskXmlBody=createTaskXmlBody, jdcloudRequestBody=jdcloudRequestBody)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->createTaskXml: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_createTaskXml_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    Required
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">createTaskXmlBody </td>
<td>
...
$(document).ready(function() {
  var schemaWrapper = {
  "in" : "body",
  "name" : "create_task_xmlBody",
  "description" : "",
  "required" : false
};
  var schema = schemaWrapper.schema;
  if (schema.$ref != null) {
    schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/createTaskXml_')
    schema = defsParser.$refs.get(schema.$ref);
  } else {
    schemaWrapper.definitions = Object.assign({}, defs);
    $RefParser.dereference(schemaWrapper).catch(function(err) {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_createTaskXml_createTaskXmlBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_createTaskXml_createTaskXmlBody"></div>
</td>
</tr>
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_createTaskXml_jdcloudRequestBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_createTaskXml_jdcloudRequestBody"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-createTaskXml-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-createTaskXml-200-schema">
                                  <div id='responses-createTaskXml-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/result"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-createTaskXml-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-createTaskXml-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-createTaskXml-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-deleteTask">
                      <article id="api-Default-deleteTask-0" data-group="User" data-name="deleteTask" data-version="0">
                        <div class="pull-left">
                          <h1>deleteTask</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">delete_task</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/todo/api/v1/tasks/deleteTaskById/{taskid}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-deleteTask-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-deleteTask-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-deleteTask-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-deleteTask-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-deleteTask-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-deleteTask-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-deleteTask-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-deleteTask-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-deleteTask-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-deleteTask-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-deleteTask-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-deleteTask-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/deleteTaskById/{taskid}"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-deleteTask-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
        try {
            DeleteTaskresponse result = apiInstance.deleteTask(taskid, authorTest);
            System.out.println(result);
        } catch (ApiException e) {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Default-deleteTask-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-deleteTask-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-deleteTask-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *taskid = 56; // taskid
String *authorTest = authorTest_example; // Authorization (default to Authorization)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance deleteTaskWith:taskid
    authorTest:authorTest
              completionHandler: ^(DeleteTaskresponse output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Default-deleteTask-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');

var api = new .DefaultApi()

var taskid = 56; // {Integer} taskid
...
api.deleteTask(taskid, authorTest, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-deleteTask-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-deleteTask-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling DefaultApi.deleteTask: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Default-deleteTask-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\DefaultApi();
$taskid = 56; // Integer | taskid
$authorTest = authorTest_example; // String | Authorization

try {
    $result = $api_instance->deleteTask($taskid, $authorTest);
    print_r($result);
} catch (Exception $e) {
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Default-deleteTask-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;

my $api_instance = ::DefaultApi->new();
my $taskid = 56; # Integer | taskid
my $authorTest = authorTest_example; # String | Authorization

eval { 
    my $result = $api_instance->deleteTask(taskid => $taskid, authorTest => $authorTest);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->deleteTask: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Default-deleteTask-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.delete_task(taskid, authorTest)
    pprint(api_response)
except ApiException as e:
...
<td>
    ...
    <div id="d2e199_deleteTask_taskid">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_deleteTask_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-deleteTask-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-deleteTask-200-schema">
                                  <div id='responses-deleteTask-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    ...
    "properties" : { }
                                        ...
                                        var schema = schemaWrapper.schema;
                                        if (schema.$ref != null) {
                                          schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/deleteTask_')
                                          schema = defsParser.$refs.get(schema.$ref);
                                        } else {
                                          schemaWrapper.definitions = Object.assign({}, defs);
                                          $RefParser.dereference(schemaWrapper).catch(function(err) {
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-deleteTask-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-deleteTask-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-deleteTask-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-getAllTask">
                      <article id="api-Default-getAllTask-0" data-group="User" data-name="getAllTask" data-version="0">
                        <div class="pull-left">
                          <h1>getAllTask</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">get_all_task</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/getAllOrUniqueTask</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-getAllTask-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-getAllTask-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-getAllTask-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-getAllTask-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-getAllTask-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-getAllTask-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-getAllTask-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-getAllTask-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-getAllTask-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-getAllTask-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-getAllTask-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-getAllTask-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/getAllOrUniqueTask?title=&ampdone=&ampdescription="</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-getAllTask-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String done = done_example; // String | done
        String description = description_example; // String | description
        try {
            GetAllTaskresponse result = apiInstance.getAllTask(authorTest, title, done, description);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#getAllTask");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-getAllTask-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-getAllTask-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-getAllTask-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)
String *title = title_example; // title (optional) (default to Title_123)
String *done = done_example; // done (optional) (default to false)
String *description = description_example; // description (optional) (default to description)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance getAllTaskWith:authorTest
    title:title
    done:done
    description:description
              completionHandler: ^(GetAllTaskresponse output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Default-getAllTask-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.getAllTask(authorTest, opts, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-getAllTask-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-getAllTask-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class getAllTaskExample
    {
        public void main()
        {
            ...
            var apiInstance = new DefaultApi();
            var authorTest = authorTest_example;  // String | Authorization (default to Authorization)
            var title = title_example;  // String | title (optional)  (default to Title_123)
            var done = done_example;  // String | done (optional)  (default to false)
            var description = description_example;  // String | description (optional)  (default to description)
            ...
            {
                Debug.Print("Exception when calling DefaultApi.getAllTask: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-getAllTask-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->getAllTask($authorTest, $title, $done, $description);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->getAllTask: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-getAllTask-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
my $api_instance = ::DefaultApi->new();
my $authorTest = authorTest_example; # String | Authorization
my $title = title_example; # String | title
my $done = done_example; # String | done
my $description = description_example; # String | description

eval { 
    my $result = $api_instance->getAllTask(authorTest => $authorTest, title => $title, done => $done, description => $description);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->getAllTask: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-getAllTask-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
api_instance = .DefaultApi()
authorTest = authorTest_example # String | Authorization (default to Authorization)
title = title_example # String | title (optional) (default to Title_123)
done = done_example # String | done (optional) (default to false)
description = description_example # String | description (optional) (default to description)

try: 
    api_response = api_instance.get_all_task(authorTest, title=title, done=done, description=description)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->getAllTask: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_getAllTask_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_getAllTask_title">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        title
                                ...
                                <tr><td style="width:150px;">done</td>
<td>


    <div id="d2e199_getAllTask_done">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_getAllTask_description">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        description
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getAllTask-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getAllTask-200-schema">
                                  <div id='responses-getAllTask-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    ...
    "properties" : { }
                                        ...
                                        var schema = schemaWrapper.schema;
                                        if (schema.$ref != null) {
                                          schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/getAllTask_')
                                          schema = defsParser.$refs.get(schema.$ref);
                                        } else {
                                          schemaWrapper.definitions = Object.assign({}, defs);
                                          $RefParser.dereference(schemaWrapper).catch(function(err) {
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getAllTask-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getAllTask-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getAllTask-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-getSelectTask">
                      <article id="api-Default-getSelectTask-0" data-group="User" data-name="getSelectTask" data-version="0">
                        <div class="pull-left">
                          <h1>getSelectTask</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">get_select_task</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/getTaskById/{taskid}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-getSelectTask-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-getSelectTask-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-getSelectTask-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-getSelectTask-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-getSelectTask-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-getSelectTask-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-getSelectTask-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-getSelectTask-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-getSelectTask-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-getSelectTask-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-getSelectTask-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-getSelectTask-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/getTaskById/{taskid}"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-getSelectTask-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
        try {
            result result = apiInstance.getSelectTask(taskid, authorTest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#getSelectTask");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-getSelectTask-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-getSelectTask-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-getSelectTask-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *taskid = 56; // taskid
String *authorTest = authorTest_example; // Authorization (default to Authorization)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance getSelectTaskWith:taskid
    authorTest:authorTest
              completionHandler: ^(result output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Default-getSelectTask-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.getSelectTask(taskid, authorTest, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-getSelectTask-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-getSelectTask-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class getSelectTaskExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.getSelectTask: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-getSelectTask-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->getSelectTask($taskid, $authorTest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->getSelectTask: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-getSelectTask-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
eval { 
    my $result = $api_instance->getSelectTask(taskid => $taskid, authorTest => $authorTest);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->getSelectTask: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-getSelectTask-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.get_select_task(taskid, authorTest)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->getSelectTask: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_getSelectTask_taskid">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_getSelectTask_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getSelectTask-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getSelectTask-200-schema">
                                  <div id='responses-getSelectTask-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/result"
                                        ...
                                        var schema = schemaWrapper.schema;
                                        if (schema.$ref != null) {
                                          schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/getSelectTask_')
                                          schema = defsParser.$refs.get(schema.$ref);
                                        } else {
                                          schemaWrapper.definitions = Object.assign({}, defs);
                                          $RefParser.dereference(schemaWrapper).catch(function(err) {
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getSelectTask-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getSelectTask-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getSelectTask-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-patchTaskJson">
                      <article id="api-Default-patchTaskJson-0" data-group="User" data-name="patchTaskJson" data-version="0">
                        <div class="pull-left">
                          <h1>patchTaskJson</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">patch_task_json</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="patch"><code><span class="pln">/todo/api/v1/tasks/modifyTaskById/{taskid}/json</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-patchTaskJson-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-patchTaskJson-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-patchTaskJson-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-patchTaskJson-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-patchTaskJson-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-patchTaskJson-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-patchTaskJson-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-patchTaskJson-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-patchTaskJson-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-patchTaskJson-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-patchTaskJson-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-patchTaskJson-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PATCH "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/modifyTaskById/{taskid}/json"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-patchTaskJson-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        Object jdcloudRequestBody = ; // Object | 
        try {
            result result = apiInstance.patchTaskJson(taskid, authorTest, patchTaskJsonBody, jdcloudRequestBody);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#patchTaskJson");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-patchTaskJson-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-patchTaskJson-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-patchTaskJson-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *taskid = 56; // taskid
String *authorTest = authorTest_example; // Authorization (default to Authorization)
 *patchTaskJsonBody = ; //  (optional)
Object *jdcloudRequestBody = ; //  (optional)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance patchTaskJsonWith:taskid
    authorTest:authorTest
    patchTaskJsonBody:patchTaskJsonBody
    jdcloudRequestBody:jdcloudRequestBody
              completionHandler: ^(result output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Default-patchTaskJson-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.patchTaskJson(taskid, authorTest, opts, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-patchTaskJson-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-patchTaskJson-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class patchTaskJsonExample
    {
        public void main()
        {
            ...
            var taskid = 56;  // Integer | taskid
            var authorTest = authorTest_example;  // String | Authorization (default to Authorization)
            var patchTaskJsonBody = new (); //  |  (optional) 
            var jdcloudRequestBody = new Object(); // Object |  (optional) 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.patchTaskJson: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-patchTaskJson-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->patchTaskJson($taskid, $authorTest, $patchTaskJsonBody, $jdcloudRequestBody);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->patchTaskJson: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-patchTaskJson-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
my $taskid = 56; # Integer | taskid
my $authorTest = authorTest_example; # String | Authorization
my $patchTaskJsonBody = ::Object::->new(); #  | 
my $jdcloudRequestBody = ::Object::Object->new(); # Object | 

eval { 
    my $result = $api_instance->patchTaskJson(taskid => $taskid, authorTest => $authorTest, patchTaskJsonBody => $patchTaskJsonBody, jdcloudRequestBody => $jdcloudRequestBody);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->patchTaskJson: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-patchTaskJson-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.patch_task_json(taskid, authorTest, patchTaskJsonBody=patchTaskJsonBody, jdcloudRequestBody=jdcloudRequestBody)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->patchTaskJson: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_patchTaskJson_taskid">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_patchTaskJson_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    Required
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">patchTaskJsonBody </td>
<td>
...
$(document).ready(function() {
  var schemaWrapper = {
  "in" : "body",
  "name" : "patch_task_jsonBody",
  "description" : "",
  "required" : false
};
  var schema = schemaWrapper.schema;
  if (schema.$ref != null) {
    schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/patchTaskJson_')
    schema = defsParser.$refs.get(schema.$ref);
  } else {
    schemaWrapper.definitions = Object.assign({}, defs);
    $RefParser.dereference(schemaWrapper).catch(function(err) {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_patchTaskJson_patchTaskJsonBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_patchTaskJson_patchTaskJsonBody"></div>
</td>
</tr>
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_patchTaskJson_jdcloudRequestBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_patchTaskJson_jdcloudRequestBody"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-patchTaskJson-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-patchTaskJson-200-schema">
                                  <div id='responses-patchTaskJson-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/result"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-patchTaskJson-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-patchTaskJson-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-patchTaskJson-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-patchTaskXml">
                      <article id="api-Default-patchTaskXml-0" data-group="User" data-name="patchTaskXml" data-version="0">
                        <div class="pull-left">
                          <h1>patchTaskXml</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">patch_task_xml</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="patch"><code><span class="pln">/todo/api/v1/tasks/modifyTaskById/{taskid}/xml</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-patchTaskXml-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-patchTaskXml-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-patchTaskXml-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-patchTaskXml-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-patchTaskXml-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-patchTaskXml-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-patchTaskXml-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-patchTaskXml-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-patchTaskXml-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-patchTaskXml-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-patchTaskXml-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-patchTaskXml-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PATCH "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/modifyTaskById/{taskid}/xml"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-patchTaskXml-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        Object jdcloudRequestBody = ; // Object | 
        try {
            result result = apiInstance.patchTaskXml(taskid, authorTest, patchTaskXmlBody, jdcloudRequestBody);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#patchTaskXml");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-patchTaskXml-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-patchTaskXml-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-patchTaskXml-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *taskid = 56; // taskid
String *authorTest = authorTest_example; // Authorization (default to Authorization)
 *patchTaskXmlBody = ; //  (optional)
Object *jdcloudRequestBody = ; //  (optional)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance patchTaskXmlWith:taskid
    authorTest:authorTest
    patchTaskXmlBody:patchTaskXmlBody
    jdcloudRequestBody:jdcloudRequestBody
              completionHandler: ^(result output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Default-patchTaskXml-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.patchTaskXml(taskid, authorTest, opts, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-patchTaskXml-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-patchTaskXml-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class patchTaskXmlExample
    {
        public void main()
        {
            ...
            var taskid = 56;  // Integer | taskid
            var authorTest = authorTest_example;  // String | Authorization (default to Authorization)
            var patchTaskXmlBody = new (); //  |  (optional) 
            var jdcloudRequestBody = new Object(); // Object |  (optional) 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.patchTaskXml: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-patchTaskXml-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->patchTaskXml($taskid, $authorTest, $patchTaskXmlBody, $jdcloudRequestBody);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->patchTaskXml: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-patchTaskXml-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
my $taskid = 56; # Integer | taskid
my $authorTest = authorTest_example; # String | Authorization
my $patchTaskXmlBody = ::Object::->new(); #  | 
my $jdcloudRequestBody = ::Object::Object->new(); # Object | 

eval { 
    my $result = $api_instance->patchTaskXml(taskid => $taskid, authorTest => $authorTest, patchTaskXmlBody => $patchTaskXmlBody, jdcloudRequestBody => $jdcloudRequestBody);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->patchTaskXml: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-patchTaskXml-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.patch_task_xml(taskid, authorTest, patchTaskXmlBody=patchTaskXmlBody, jdcloudRequestBody=jdcloudRequestBody)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->patchTaskXml: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_patchTaskXml_taskid">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_patchTaskXml_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    Required
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">patchTaskXmlBody </td>
<td>
...
$(document).ready(function() {
  var schemaWrapper = {
  "in" : "body",
  "name" : "patch_task_xmlBody",
  "description" : "",
  "required" : false
};
  var schema = schemaWrapper.schema;
  if (schema.$ref != null) {
    schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/patchTaskXml_')
    schema = defsParser.$refs.get(schema.$ref);
  } else {
    schemaWrapper.definitions = Object.assign({}, defs);
    $RefParser.dereference(schemaWrapper).catch(function(err) {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_patchTaskXml_patchTaskXmlBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_patchTaskXml_patchTaskXmlBody"></div>
</td>
</tr>
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_patchTaskXml_jdcloudRequestBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_patchTaskXml_jdcloudRequestBody"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-patchTaskXml-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-patchTaskXml-200-schema">
                                  <div id='responses-patchTaskXml-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/result"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-patchTaskXml-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-patchTaskXml-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-patchTaskXml-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-putTaskJson">
                      <article id="api-Default-putTaskJson-0" data-group="User" data-name="putTaskJson" data-version="0">
                        <div class="pull-left">
                          <h1>putTaskJson</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">put_task_json</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/todo/api/v1/tasks/modifyTaskById/{taskid}/json</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-putTaskJson-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-putTaskJson-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-putTaskJson-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-putTaskJson-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-putTaskJson-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-putTaskJson-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-putTaskJson-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-putTaskJson-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-putTaskJson-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-putTaskJson-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-putTaskJson-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-putTaskJson-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/modifyTaskById/{taskid}/json"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-putTaskJson-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        Object jdcloudRequestBody = ; // Object | 
        try {
            result result = apiInstance.putTaskJson(taskid, authorTest, putTaskJsonBody, jdcloudRequestBody);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#putTaskJson");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-putTaskJson-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-putTaskJson-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-putTaskJson-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *taskid = 56; // taskid
String *authorTest = authorTest_example; // Authorization (default to Authorization)
 *putTaskJsonBody = ; //  (optional)
Object *jdcloudRequestBody = ; //  (optional)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance putTaskJsonWith:taskid
    authorTest:authorTest
    putTaskJsonBody:putTaskJsonBody
    jdcloudRequestBody:jdcloudRequestBody
              completionHandler: ^(result output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Default-putTaskJson-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.putTaskJson(taskid, authorTest, opts, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-putTaskJson-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-putTaskJson-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class putTaskJsonExample
    {
        public void main()
        {
            ...
            var taskid = 56;  // Integer | taskid
            var authorTest = authorTest_example;  // String | Authorization (default to Authorization)
            var putTaskJsonBody = new (); //  |  (optional) 
            var jdcloudRequestBody = new Object(); // Object |  (optional) 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.putTaskJson: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-putTaskJson-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->putTaskJson($taskid, $authorTest, $putTaskJsonBody, $jdcloudRequestBody);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->putTaskJson: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-putTaskJson-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
my $taskid = 56; # Integer | taskid
my $authorTest = authorTest_example; # String | Authorization
my $putTaskJsonBody = ::Object::->new(); #  | 
my $jdcloudRequestBody = ::Object::Object->new(); # Object | 

eval { 
    my $result = $api_instance->putTaskJson(taskid => $taskid, authorTest => $authorTest, putTaskJsonBody => $putTaskJsonBody, jdcloudRequestBody => $jdcloudRequestBody);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->putTaskJson: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-putTaskJson-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.put_task_json(taskid, authorTest, putTaskJsonBody=putTaskJsonBody, jdcloudRequestBody=jdcloudRequestBody)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->putTaskJson: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_putTaskJson_taskid">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_putTaskJson_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    Required
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">putTaskJsonBody </td>
<td>
...
$(document).ready(function() {
  var schemaWrapper = {
  "in" : "body",
  "name" : "put_task_jsonBody",
  "description" : "",
  "required" : false
};
  var schema = schemaWrapper.schema;
  if (schema.$ref != null) {
    schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/putTaskJson_')
    schema = defsParser.$refs.get(schema.$ref);
  } else {
    schemaWrapper.definitions = Object.assign({}, defs);
    $RefParser.dereference(schemaWrapper).catch(function(err) {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_putTaskJson_putTaskJsonBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_putTaskJson_putTaskJsonBody"></div>
</td>
</tr>
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_putTaskJson_jdcloudRequestBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_putTaskJson_jdcloudRequestBody"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-putTaskJson-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-putTaskJson-200-schema">
                                  <div id='responses-putTaskJson-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/result"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-putTaskJson-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-putTaskJson-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-putTaskJson-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-putTaskXml">
                      <article id="api-Default-putTaskXml-0" data-group="User" data-name="putTaskXml" data-version="0">
                        <div class="pull-left">
                          <h1>putTaskXml</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">put_task_xml</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/todo/api/v1/tasks/modifyTaskById/{taskid}/xml</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-putTaskXml-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-putTaskXml-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-putTaskXml-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-putTaskXml-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-putTaskXml-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-putTaskXml-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-putTaskXml-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-putTaskXml-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-putTaskXml-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-putTaskXml-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-putTaskXml-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-putTaskXml-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/modifyTaskById/{taskid}/xml"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-putTaskXml-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        Object jdcloudRequestBody = ; // Object | 
        try {
            result result = apiInstance.putTaskXml(taskid, authorTest, putTaskXmlBody, jdcloudRequestBody);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#putTaskXml");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-putTaskXml-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-putTaskXml-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-putTaskXml-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *taskid = 56; // taskid
String *authorTest = authorTest_example; // Authorization (default to Authorization)
 *putTaskXmlBody = ; //  (optional)
Object *jdcloudRequestBody = ; //  (optional)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance putTaskXmlWith:taskid
    authorTest:authorTest
    putTaskXmlBody:putTaskXmlBody
    jdcloudRequestBody:jdcloudRequestBody
              completionHandler: ^(result output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Default-putTaskXml-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.putTaskXml(taskid, authorTest, opts, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-putTaskXml-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-putTaskXml-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class putTaskXmlExample
    {
        public void main()
        {
            ...
            var taskid = 56;  // Integer | taskid
            var authorTest = authorTest_example;  // String | Authorization (default to Authorization)
            var putTaskXmlBody = new (); //  |  (optional) 
            var jdcloudRequestBody = new Object(); // Object |  (optional) 
            ...
            {
                Debug.Print("Exception when calling DefaultApi.putTaskXml: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-putTaskXml-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->putTaskXml($taskid, $authorTest, $putTaskXmlBody, $jdcloudRequestBody);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->putTaskXml: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-putTaskXml-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
my $taskid = 56; # Integer | taskid
my $authorTest = authorTest_example; # String | Authorization
my $putTaskXmlBody = ::Object::->new(); #  | 
my $jdcloudRequestBody = ::Object::Object->new(); # Object | 

eval { 
    my $result = $api_instance->putTaskXml(taskid => $taskid, authorTest => $authorTest, putTaskXmlBody => $putTaskXmlBody, jdcloudRequestBody => $jdcloudRequestBody);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->putTaskXml: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-putTaskXml-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.put_task_xml(taskid, authorTest, putTaskXmlBody=putTaskXmlBody, jdcloudRequestBody=jdcloudRequestBody)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->putTaskXml: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_putTaskXml_taskid">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_putTaskXml_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    Required
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">putTaskXmlBody </td>
<td>
...
$(document).ready(function() {
  var schemaWrapper = {
  "in" : "body",
  "name" : "put_task_xmlBody",
  "description" : "",
  "required" : false
};
  var schema = schemaWrapper.schema;
  if (schema.$ref != null) {
    schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/putTaskXml_')
    schema = defsParser.$refs.get(schema.$ref);
  } else {
    schemaWrapper.definitions = Object.assign({}, defs);
    $RefParser.dereference(schemaWrapper).catch(function(err) {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_putTaskXml_putTaskXmlBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_putTaskXml_putTaskXmlBody"></div>
</td>
</tr>
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_putTaskXml_jdcloudRequestBody');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_putTaskXml_jdcloudRequestBody"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-putTaskXml-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-putTaskXml-200-schema">
                                  <div id='responses-putTaskXml-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/result"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-putTaskXml-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-putTaskXml-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-putTaskXml-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-getError">
                      <article id="api-Default-getError-0" data-group="User" data-name="getError" data-version="0">
                        <div class="pull-left">
                          <h1>getError</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">get_error</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/getError/{errno}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-getError-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-getError-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-getError-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-getError-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-getError-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-getError-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-getError-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-getError-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-getError-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-getError-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-getError-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-getError-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/getError/{errno}"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-getError-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi();
        Integer errno = 56; // Integer | errno
        try {
            GetErrorresponse result = apiInstance.getError(errno);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#getError");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-getError-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-getError-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-getError-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *errno = 56; // errno

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance getErrorWith:errno
              completionHandler: ^(GetErrorresponse output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Default-getError-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');

var api = new .DefaultApi()

var errno = 56; // {Integer} errno
...
api.getError(errno, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-getError-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-getError-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class getErrorExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.getError: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-getError-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\DefaultApi();
$errno = 56; // Integer | errno

try {
    $result = $api_instance->getError($errno);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->getError: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-getError-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;

my $api_instance = ::DefaultApi->new();
my $errno = 56; # Integer | errno

eval { 
    my $result = $api_instance->getError(errno => $errno);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->getError: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-getError-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.get_error(errno)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->getError: %s\n" % e)</code></pre>
                            </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">errno*</td>
<td>


    <div id="d2e199_getError_errno">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getError-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getError-200-schema">
                                  <div id='responses-getError-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    ...
    "properties" : { }
                                        ...
                                        var schema = schemaWrapper.schema;
                                        if (schema.$ref != null) {
                                          schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/getError_')
                                          schema = defsParser.$refs.get(schema.$ref);
                                        } else {
                                          schemaWrapper.definitions = Object.assign({}, defs);
                                          $RefParser.dereference(schemaWrapper).catch(function(err) {
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getError-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getError-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getError-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-returnHeader">
                      <article id="api-Default-returnHeader-0" data-group="User" data-name="returnHeader" data-version="0">
                        <div class="pull-left">
                          <h1>returnHeader</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">return_header</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/returnAllHead</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-returnHeader-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-returnHeader-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-returnHeader-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-returnHeader-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-returnHeader-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-returnHeader-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-returnHeader-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-returnHeader-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-returnHeader-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-returnHeader-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-returnHeader-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-returnHeader-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/returnAllHead"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-returnHeader-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi();
        String tanCoong = tanCoong_example; // String | TanCoong
        String lishijun = lishijun_example; // String | Lishijun
        String lixuenan = lixuenan_example; // String | Lixuenan
        try {
            ReturnHeaderresponse result = apiInstance.returnHeader(tanCoong, lishijun, lixuenan);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#returnHeader");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-returnHeader-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-returnHeader-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-returnHeader-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *tanCoong = tanCoong_example; // TanCoong (default to TanCoong)
String *lishijun = lishijun_example; // Lishijun (default to Lishijun)
String *lixuenan = lixuenan_example; // Lixuenan (default to Lixuenan)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance returnHeaderWith:tanCoong
    lishijun:lishijun
    lixuenan:lixuenan
              completionHandler: ^(ReturnHeaderresponse output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Default-returnHeader-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');

var api = new .DefaultApi()

var tanCoong = tanCoong_example; // {String} TanCoong

var lishijun = lishijun_example; // {String} Lishijun

var lixuenan = lixuenan_example; // {String} Lixuenan
...
api.returnHeader(tanCoong, lishijun, lixuenan, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnHeader-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-returnHeader-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class returnHeaderExample
    {
        public void main()
        {
            
            var apiInstance = new DefaultApi();
            var tanCoong = tanCoong_example;  // String | TanCoong (default to TanCoong)
            var lishijun = lishijun_example;  // String | Lishijun (default to Lishijun)
            var lixuenan = lixuenan_example;  // String | Lixuenan (default to Lixuenan)
            ...
            {
                Debug.Print("Exception when calling DefaultApi.returnHeader: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-returnHeader-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\DefaultApi();
$tanCoong = tanCoong_example; // String | TanCoong
$lishijun = lishijun_example; // String | Lishijun
$lixuenan = lixuenan_example; // String | Lixuenan

try {
    $result = $api_instance->returnHeader($tanCoong, $lishijun, $lixuenan);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->returnHeader: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnHeader-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;

my $api_instance = ::DefaultApi->new();
my $tanCoong = tanCoong_example; # String | TanCoong
my $lishijun = lishijun_example; # String | Lishijun
my $lixuenan = lixuenan_example; # String | Lixuenan

eval { 
    my $result = $api_instance->returnHeader(tanCoong => $tanCoong, lishijun => $lishijun, lixuenan => $lixuenan);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->returnHeader: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnHeader-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
# create an instance of the API class
api_instance = .DefaultApi()
tanCoong = tanCoong_example # String | TanCoong (default to TanCoong)
lishijun = lishijun_example # String | Lishijun (default to Lishijun)
lixuenan = lixuenan_example # String | Lixuenan (default to Lixuenan)

try: 
    api_response = api_instance.return_header(tanCoong, lishijun, lixuenan)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->returnHeader: %s\n" % e)</code></pre>
                            </div>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <th>Description</th>
                                  ...
                                  <tr><td style="width:150px;">TanCoong*</td>
<td>


    <div id="d2e199_returnHeader_tanCoong">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                                  ...
                                  <tr><td style="width:150px;">Lishijun*</td>
<td>


    <div id="d2e199_returnHeader_lishijun">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                                  ...
                                  <tr><td style="width:150px;">Lixuenan*</td>
<td>


    <div id="d2e199_returnHeader_lixuenan">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-returnHeader-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-returnHeader-200-schema">
                                  <div id='responses-returnHeader-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    ...
    "properties" : { }
                                        ...
                                        var schema = schemaWrapper.schema;
                                        if (schema.$ref != null) {
                                          schema.$ref = schema.$ref.replace('#/definitions/', '#/definitions/returnHeader_')
                                          schema = defsParser.$refs.get(schema.$ref);
                                        } else {
                                          schemaWrapper.definitions = Object.assign({}, defs);
                                          $RefParser.dereference(schemaWrapper).catch(function(err) {
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-returnHeader-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-returnHeader-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-returnHeader-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Default-returnString">
                      <article id="api-Default-returnString-0" data-group="User" data-name="returnString" data-version="0">
                        <div class="pull-left">
                          <h1>returnString</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">return_string</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/returntype/string</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-returnString-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-returnString-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-returnString-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-returnString-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-returnString-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-returnString-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-returnString-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-returnString-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-returnString-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-returnString-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-returnString-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-returnString-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/returntype/string"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-returnString-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
        try {
            ReturnStringresponse result = apiInstance.returnString(authorTest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#returnString");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-returnString-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-returnString-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-returnString-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance returnStringWith:authorTest
              completionHandler: ^(NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Default-returnString-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.returnString(authorTest, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnString-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-returnString-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class returnStringExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.returnString: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-returnString-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->returnString($authorTest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->returnString: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnString-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
eval { 
    my $result = $api_instance->returnString(authorTest => $authorTest);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->returnString: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnString-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.return_string(authorTest)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->returnString: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_returnString_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    ...
                    <div id="api-Default-returnFloat">
                      <article id="api-Default-returnFloat-0" data-group="User" data-name="returnFloat" data-version="0">
                        <div class="pull-left">
                          <h1>returnFloat</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">return_float</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/returntype/float</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-returnFloat-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-returnFloat-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-returnFloat-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-returnFloat-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-returnFloat-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-returnFloat-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-returnFloat-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-returnFloat-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-returnFloat-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-returnFloat-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-returnFloat-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-returnFloat-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/returntype/float"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-returnFloat-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
        try {
            ReturnFloatresponse result = apiInstance.returnFloat(authorTest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#returnFloat");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-returnFloat-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-returnFloat-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-returnFloat-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance returnFloatWith:authorTest
              completionHandler: ^(NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Default-returnFloat-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.returnFloat(authorTest, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnFloat-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-returnFloat-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class returnFloatExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.returnFloat: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-returnFloat-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->returnFloat($authorTest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->returnFloat: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnFloat-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
eval { 
    my $result = $api_instance->returnFloat(authorTest => $authorTest);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->returnFloat: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnFloat-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.return_float(authorTest)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->returnFloat: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_returnFloat_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    ...
                    <div id="api-Default-returnInt32">
                      <article id="api-Default-returnInt32-0" data-group="User" data-name="returnInt32" data-version="0">
                        <div class="pull-left">
                          <h1>returnInt32</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">return_int32</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/returntype/int32</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-returnInt32-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-returnInt32-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-returnInt32-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-returnInt32-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-returnInt32-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-returnInt32-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-returnInt32-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-returnInt32-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-returnInt32-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-returnInt32-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-returnInt32-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-returnInt32-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/returntype/int32"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-returnInt32-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
        try {
            ReturnInt32response result = apiInstance.returnInt32(authorTest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#returnInt32");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-returnInt32-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-returnInt32-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-returnInt32-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance returnInt32With:authorTest
              completionHandler: ^(NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Default-returnInt32-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.returnInt32(authorTest, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnInt32-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-returnInt32-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class returnInt32Example
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.returnInt32: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-returnInt32-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->returnInt32($authorTest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->returnInt32: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnInt32-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
eval { 
    my $result = $api_instance->returnInt32(authorTest => $authorTest);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->returnInt32: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnInt32-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.return_int32(authorTest)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->returnInt32: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_returnInt32_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    ...
                    <div id="api-Default-returnBoolean">
                      <article id="api-Default-returnBoolean-0" data-group="User" data-name="returnBoolean" data-version="0">
                        <div class="pull-left">
                          <h1>returnBoolean</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">return_boolean</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/returntype/boolean</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-returnBoolean-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-returnBoolean-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-returnBoolean-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-returnBoolean-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-returnBoolean-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-returnBoolean-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-returnBoolean-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-returnBoolean-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-returnBoolean-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-returnBoolean-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-returnBoolean-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-returnBoolean-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/returntype/boolean"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-returnBoolean-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
        try {
            ReturnBooleanresponse result = apiInstance.returnBoolean(authorTest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#returnBoolean");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-returnBoolean-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-returnBoolean-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-returnBoolean-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance returnBooleanWith:authorTest
              completionHandler: ^(NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Default-returnBoolean-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.returnBoolean(authorTest, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnBoolean-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-returnBoolean-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class returnBooleanExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.returnBoolean: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-returnBoolean-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->returnBoolean($authorTest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->returnBoolean: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnBoolean-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
eval { 
    my $result = $api_instance->returnBoolean(authorTest => $authorTest);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->returnBoolean: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnBoolean-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.return_boolean(authorTest)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->returnBoolean: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_returnBoolean_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    ...
                    <div id="api-Default-returnDouble">
                      <article id="api-Default-returnDouble-0" data-group="User" data-name="returnDouble" data-version="0">
                        <div class="pull-left">
                          <h1>returnDouble</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">return_double</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/returntype/double</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-returnDouble-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-returnDouble-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-returnDouble-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-returnDouble-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-returnDouble-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-returnDouble-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-returnDouble-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-returnDouble-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-returnDouble-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-returnDouble-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-returnDouble-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-returnDouble-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/returntype/double"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-returnDouble-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
        try {
            ReturnDoubleresponse result = apiInstance.returnDouble(authorTest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#returnDouble");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-returnDouble-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-returnDouble-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-returnDouble-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance returnDoubleWith:authorTest
              completionHandler: ^(NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Default-returnDouble-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.returnDouble(authorTest, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnDouble-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-returnDouble-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class returnDoubleExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.returnDouble: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-returnDouble-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->returnDouble($authorTest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->returnDouble: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnDouble-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
eval { 
    my $result = $api_instance->returnDouble(authorTest => $authorTest);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->returnDouble: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnDouble-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.return_double(authorTest)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->returnDouble: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_returnDouble_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    ...
                    <div id="api-Default-returnDate">
                      <article id="api-Default-returnDate-0" data-group="User" data-name="returnDate" data-version="0">
                        <div class="pull-left">
                          <h1>returnDate</h1>
                          <p></p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">return_date</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/todo/api/v1/tasks/returntype/date</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-returnDate-0-curl">Curl</a></li>
                          <!--<li class=""><a href="#examples-Default-returnDate-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-returnDate-0-android">Android</a></li>
                          <li class=""><a href="#examples-Default-returnDate-0-groovy">Groovy</a></li>
                          <li class=""><a href="#examples-Default-returnDate-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-returnDate-0-javascript">JavaScript</a></li>
                          <li class=""><a href="#examples-Default-returnDate-0-angular">Angular</a></li>
                          <li class=""><a href="#examples-Default-returnDate-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-returnDate-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-returnDate-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-returnDate-0-python">Python</a></li>-->
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-returnDate-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://w9najhegwrr2.cn-north-1.jdcloud-api.net/todo/api/v1/tasks/returntype/date"</code></pre>
                          </div>
<!--

                          <div class="tab-pane" id="examples-Default-returnDate-0-java">
                            <pre class="prettyprint"><code class="language-java">import .*;
import .auth.*;
import .model.*;
import .api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorTest = authorTest_example; // String | Authorization
        try {
            ReturnDateresponse result = apiInstance.returnDate(authorTest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#returnDate");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-returnDate-0-android">
                            <pre class="prettyprint"><code class="language-java">import .api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <div class="tab-pane" id="examples-Default-returnDate-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div>
                            <div class="tab-pane" id="examples-Default-returnDate-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorTest = authorTest_example; // Authorization (default to Authorization)

DefaultApi *apiInstance = [[DefaultApi alloc] init];

[apiInstance returnDateWith:authorTest
              completionHandler: ^(NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Default-returnDate-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var  = require('');
...
api.returnDate(authorTest, callback);
</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnDate-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>
                            <div class="tab-pane" id="examples-Default-returnDate-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using .Api;
using .Client;
...
namespace Example
{
    public class returnDateExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.returnDate: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-returnDate-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->returnDate($authorTest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->returnDate: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnDate-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use ::Configuration;
use ::DefaultApi;
...
eval { 
    my $result = $api_instance->returnDate(authorTest => $authorTest);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->returnDate: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-returnDate-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import 
from .rest import ApiException
...
try: 
    api_response = api_instance.return_date(authorTest)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->returnDate: %s\n" % e)</code></pre>
                            </div>
...
<td>
    ...
    <div id="d2e199_returnDate_authorTest">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
